...
If you have initialized your secure environment cache using `keeper vault`, you can unseal Vault directly from your laptop/desktop without SSHing into Proxmox:
```bash
